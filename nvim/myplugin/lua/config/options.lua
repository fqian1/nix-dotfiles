...
vim.opt.scrolloff = 10                                 -- Start scrolling 8 lines before reaching the edge of the viewport
...
vim.opt.colorcolumn = '100' -- Highlight column 80 (good for code style)
vim.opt.cmdheight = 1 -- Set the command bar height to 2 lines
...
vim.opt.statusline =
'%f %h%m%r %=%-14.(%l,%c%V%) %P'         -- Customize statusline: show file name, status, and cursor position
